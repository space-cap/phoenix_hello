defmodule PhoenixHelloWeb.UserAuthTest do
  use PhoenixHelloWeb.ConnCase, async: true

  alias PhoenixHello.Accounts
  alias PhoenixHello.Accounts.Scope
  alias PhoenixHelloWeb.UserAuth

  import PhoenixHello.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhoenixHelloWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
